  ...
  return (
    <div className={styles.background}>
      ...
      <div className={styles.buttonsContainer}>
        <Button onClick={handleClickLucoil} text={'ЛУКОЙЛ'} className={styles.contentButtonRed} iconSrc={'/images/manag-button-luk.png'} />
        <Button onClick={handleClickRitec} text={'РИТЭК'} className={styles.contentButton} iconSrc={'/images/manag-button-ritek.png'} />
      </div>
